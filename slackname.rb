...
emoji = %w{
  ...
  alembic alien amphora anchor angel ant apple
  ...
  closed_umbrella cloud cocktail coffee comet compression
  ...
  film_frames film_projector fire fireworks
  ...
  hatched_chick hatching_chick headphones heart_eyes
  ...
  om_symbol oncoming_automobile oncoming_bus
  oncoming_taxi open_hands orange_book ox package page_facing_up
  page_with_curl pager panda_face paperclip partly_sunny
  ...
  point_up_2 poodle popcorn post_office postal_horn pouch
  ...
  scissors scorpion seedling shamrock
  ...
  ticket tiger2 tiger timer_clock tokyo_tower tomato
