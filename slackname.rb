...
emoji = %w{
  ...
  bento bicyclist bike biohazard_sign bird birthday black_joker
  black_nib blossom blowfish blue_book blue_car blue_heart blush
  boar boat bomb book bookmark books boom boot bouquet bow
  ...
  crossed_flags crossed_swords crystal_ball curly_loop curry custard
  cyclone dagger_knife dancer dancers dango dark_sunglasses dart
  ...
  flower_playing_cards fog foggy football footprints fork_and_knife
  ...
  high_heel hocho honey_pot horse horse_racing hot_pepper hotdog
  ...
  kimono kissing_cat knife_fork_plate koala label last_quarter_moon
  ...
  mountain_cableway mountain_railway mouse2 mouse movie_camera moyai
  ...
  no_good no_mouth nose notebook notebook_with_decorative_cover notes
  ...
  performing_arts person_frowning person_with_ball
  ...
  scissors scorpion scroll seat see_no_evil seedling shamrock
  ...
  sports_medal stadium star2 star stars station statue_of_liberty
  ...
  vertical_traffic_light vhs video_camera video_game violin volcano
  ...
  wheel_of_dharma white_check_mark white_flower white_frowning_face
  wind_blowing_face wind_chime wine_glass wink wolf womans_clothes
  womans_hat world_map wrench writing_hand yellow_heart yen
  yin_yang yum zap zzz
}
